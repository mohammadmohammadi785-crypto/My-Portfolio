  ...
  return (
    ...
    >
      <h2 className="text-3xl sm:text-4xl font-bold mb-6 flex items-center text-gray-800">
        <User className="mr-3 h-7 sm:h-8 w-7 sm:w-8" /> About Me
      </h2>
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6 sm:gap-8">
        ...
        >
          <div className="gradient-bg w-56 h-56 sm:w-64 sm:h-64 rounded-full absolute -z-10"></div>
          <img
            src="./src/assets/img5.webp"
            alt="Your Profile"
            className="w-48 h-48 sm:w-56 sm:h-56 rounded-full object-cover border-4 border-blue-500 shadow-md relative z-10"
            onError={(e) =>
